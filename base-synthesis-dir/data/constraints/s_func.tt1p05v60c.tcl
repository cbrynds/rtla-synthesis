...
#set_clock_latency -early 0.45 [get_clocks clk]
#set_clock_latency -late  0.50 [get_clocks clk]
set_clock_latency -min 0.45 [get_clocks clk]
set_clock_latency -max 0.50 [get_clocks clk]
