"""
Copy over base synthesis directory to be used for pareto curve generation

Usage:
python setup_synthesis_dirs.py -o <synthesis_output_dir> -s <base_synthesis_dir> -d <design_config>
"""
...
def create_synthesis_directory(synthesis_output_dir, base_synthesis_dir, design_config):
    ...
    print(f"Synthesis directory created at: {synthesis_output_dir}")
    ...
    for design in design_configs["designs"]:
        design_synthesis_dir = os.path.join(synthesis_output_dir, design)
